...
comedians = Deck.create(name:"Comedians", descriptions:"Current Popular Comedians")
...
movie_stars = Deck.create(name:"TV and Movie Stars", descriptions:"Popular Actors and Actresses")
movie_stars.tweeters << Deck.create(name:"Chris Pratt", twitter_handle:"prattprattpratt")
movie_stars.tweeters << Deck.create(name:"Jennifer Lawrence", twitter_handle:"Itsjslaw")
movie_stars.tweeters << Deck.create(name:"Leonardo DiCaprio", twitter_handle:"LeoDiCaprio")
movie_stars.tweeters << Deck.create(name:"Samuel L. Jackson", twitter_handle:"SamuelLJackson")
movie_stars.tweeters << Deck.create(name:"James Franco", twitter_handle:"JamesFrancoTV")
movie_stars.tweeters << Deck.create(name:"Lena Dunham", twitter_handle:"lenadunham")
movie_stars.tweeters << Deck.create(name:"Tom Hanks", twitter_handle:"tomhanks")
movie_stars.tweeters << Deck.create(name:"Neil Patrick Harris", twitter_handle:"ActuallyNPH")
movie_stars.tweeters << Deck.create(name:"Ashtun Kutcher", twitter_handle:"aplusk")
movie_stars.tweeters << Deck.create(name:"Aaron Paul", twitter_handle:"aaronpaul_8")
movie_stars.tweeters << Deck.create(name:"Anna  Kendrick", twitter_handle:"AnnaKendrick47")
movie_stars.tweeters << Deck.create(name:"Sofia Vergara", twitter_handle:"SofiaVergara")
movie_stars.tweeters << Deck.create(name:"Kevin Spacey", twitter_handle:"KevinSpacey")
movie_stars.tweeters << Deck.create(name:"Hugh Jackman", twitter_handle:"RealHughJackman")
